...
export default function PackingPage() {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      if (res.ok) {
        const packingOrders = data.orders.filter((o: any) => o.orderStatus !== "Completed" && o.platform !== "Storefront");
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto', color: '#fff' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <h1 style={{ fontSize: '24px', fontWeight: 'bold' }}>Packing & Export</h1>
        ...
        <div style={{ display: 'flex', gap: '16px' }}>
          <input
            ...
            style={{ padding: '8px 16px', borderRadius: '4px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', color: 'white' }}
          />
          ...
          <select 
            ...
            style={{ padding: '8px 16px', borderRadius: '4px', background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', color: 'white' }}
          >
            <option value="All" style={{ color: '#000' }}>All Orders</option>
          ...
          <button 
            ...
            style={{ background: 'var(--accent-blue, #4a90e2)', border: 'none', color: '#fff', padding: '8px 16px', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px' }}
          >
            🖨️ ปริ้นใบเบิกหมู
          </button>
          ...
          <button 
            ...
            style={{ background: '#f39c12', border: 'none', color: '#fff', padding: '8px 16px', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px' }}
          >
            📤 Import Tracking
          </button>
          ...
          <button 
            onClick={async () => {
              if (confirm("ต้องการเปลี่ยนสถานะออเดอร์ของวันนี้ทั้งหมดเป็น 'Shipped' (จัดส่งแล้ว) ใช่หรือไม่?")) {
                setIsLoading(true);
                try {
            ...
            style={{ background: '#4facfe', border: 'none', color: '#fff', padding: '8px 16px', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px' }}
          >
            ✅ จบงานวันนี้ (Mark All Shipped)
          </button>
        </div>
      </div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead style={{ background: 'rgba(255,255,255,0.05)', textAlign: 'left', borderBottom: '1px solid var(--border-color)' }}>
              <tr>
                ...
                <th style={{ padding: '16px', fontWeight: 'normal', color: 'var(--text-secondary)' }}>Status</th>
                <th style={{ padding: '16px', fontWeight: 'normal', color: 'var(--text-secondary)' }}>Tracking No.</th>

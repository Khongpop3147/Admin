    ...
    <div style={{ marginTop: '8px' }}>
      ...
      {reason === SLIP_ISSUE_OTHER && (
        <input
          ...
          style={{ width: '100%', marginTop: '8px', padding: '10px 12px', borderRadius: '8px', border: '1px solid rgba(255,107,107,0.4)', background: 'rgba(0,0,0,0.2)', color: '#fff', fontSize: '13px' }}
        />
      )}
    </div>
  );
